...
for chem in chemicals:
	...
	for year in years:
		...
		# New Carb-B
		# statesCodes=[9,10,23,24,25,34,36,42,44,50,11,13]
		...
		# New CARB-A
		# statesCodes=[6,41,53,8,16,31,40,49]
		# data=data[(data['State Code']==statesCodes[0]) | (data['State Code']==statesCodes[1]) | \
		# (data['State Code']==statesCodes[2])  | (data['State Code']==statesCodes[3]) | \
		# (data['State Code']==statesCodes[4]) | (data['State Code']==statesCodes[5]) | \
		# (data['State Code']==statesCodes[6]) | (data['State Code']==statesCodes[7]) 
		...
		# Others
		stateCodesA=[6,41,53,8,16,31,40,49]
		stateCodesB=[9,10,23,24,25,34,36,42,44,50,11,13]
		noStateCode = [66,72,15,78,2]
		statesCodes=stateCodesA+stateCodesB+noStateCode
		data=data[(data['State Code']!=statesCodes[0]) & (data['State Code']!=statesCodes[1]) & \
		(data['State Code']!=statesCodes[2]) & (data['State Code']!=statesCodes[3]) & \
		(data['State Code']!=statesCodes[4]) & (data['State Code']!=statesCodes[5]) & \
		(data['State Code']!=statesCodes[6]) & (data['State Code']!=statesCodes[7]) & \
		...
		(data['State Code']!=statesCodes[14]) & (data['State Code']!=statesCodes[15]) & \
		(data['State Code']!=statesCodes[16]) & (data['State Code']!=statesCodes[17]) & \
		(data['State Code']!=statesCodes[18]) & (data['State Code']!=statesCodes[19]) & \
		(data['State Code']!=statesCodes[20]) & (data['State Code']!=statesCodes[21]) & \
		(data['State Code']!=statesCodes[22]) & (data['State Code']!=statesCodes[23]) & \
		(data['State Code']!=statesCodes[24]) 
		 ]
