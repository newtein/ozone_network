...
skip=[]
def plotNetworkGraph(waveMatrix, locations,nodeNames, filename, thresholds, nodeSize,communities):
...
communityList=os.listdir("Community/{}".format(community))
communityWrapper=[]
for com in communityList:
	temp=pickle.load(open("Community/{}/{}".format(community,com),"rb"))
	communityWrapper.append(temp)

filename="{}/map{}".format(path,'community')
nodeSize=15
thresholds=[0.0]
plotNetworkGraph(waveMatrix, locations,nodeNames, filename, thresholds, nodeSize,communityWrapper)