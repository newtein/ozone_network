...
lower_left_lon= -91.967705
lower_left_lat= 35.138228

upper_right_lon= -74.527749
upper_right_lat= 43.154208 
skip=[]
def plotNetworkGraph(waveMatrix, locations,nodeNames, filename, thresholds, nodeSize,yearInput):
	...
	for thres in thresholds:
		...
		ax.text(-0.0003, 0.98, 'b)', transform=ax.transAxes, size=12,color='purple')
		...
		plt.savefig("PMJresults_"+str(thres)+"{}.png".format(yearInput), dpi = 300,bbox_inches='tight')
